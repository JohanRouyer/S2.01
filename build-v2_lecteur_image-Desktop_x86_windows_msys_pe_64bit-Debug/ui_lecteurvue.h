...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelValeurImage->setGeometry(QRect(20, 120, 471, 351));
        QFont font5;
        font5.setPointSize(9);
        labelValeurImage->setFont(font5);
        labelValeurImage->setTextFormat(Qt::AutoText);
        labelValeurImage->setPixmap(QPixmap(QString::fromUtf8(":/diapo/cartesDisney/Disney_6.gif")));
