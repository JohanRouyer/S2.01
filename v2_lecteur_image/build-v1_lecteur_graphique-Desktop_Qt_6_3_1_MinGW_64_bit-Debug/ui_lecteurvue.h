...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelIndicateur = new QLabel(horizontalLayoutWidget);
        labelIndicateur->setObjectName(QString::fromUtf8("labelIndicateur"));
        QFont font;
        font.setPointSize(12);
        labelIndicateur->setFont(font);

        horizontalLayout->addWidget(labelIndicateur);
        ...
        labelValeurImage->setGeometry(QRect(40, 130, 471, 341));
        QFont font5;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelIndicateur->setText(QCoreApplication::translate("MainWindow", "Indicateur de mode :", nullptr));
